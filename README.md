...
> 🧩 **Теперь это ещё и плагин**: установите русификатор из маркетплейса ZCode как [плагин](https://github.com/DevGenHub/zcode-rusifikator-plugin) — с командой `/rusifikator` и авто-восстановлением после обновлений ZCode.
...
После этого в любой сессии ZCode просто скажите агенту: **«накати русификатор»** — он сам выполнит установку и вернёт перевод после обновлений.
